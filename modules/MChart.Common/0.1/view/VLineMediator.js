;(function(define, _win) { 'use strict'; define( 'MChart.Common.View.VLineMediator', [
    'MChart.Common.View.BaseVLineView'
], function( BaseVLineView ) {

    /*
     * 注意： 此处一定保持Mediator别名的唯一性 facade会按照别名区分注册的Mediator，别名相同会直接覆盖之前注册的Mediator
     */
    var MEDIATOR_NAME = 'vLineMediator';
        ...
        , {
            ...
            initialize: function( _nickName, _canvas ) {
                ...
                switch( _nickName ) {
                    ...
                    default: {
                        _viewComponent = new BaseVLineView( _canvas );
                        break;
                    }
                }
