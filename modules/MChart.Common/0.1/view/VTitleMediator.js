;(function(define, _win) { 'use strict'; define( 'MChart.Common.View.VTitleMediator', [
    'MChart.Common.View.BaseVTitleView'
], function( BaseVTitleView ) {

    /*
     * 注意： 此处一定保持Mediator别名的唯一性 facade会按照别名区分注册的Mediator，别名相同会直接覆盖之前注册的Mediator
     */
    var MEDIATOR_NAME = 'vTitleMediator';

    var BaseVTitleMediator = Objs(
        "Common.View.Mediator.VTitleMediator"
        , puremvc.Mediator
        , {
            /** 
             * @construct 
            ...
            initialize: function( _nickName, _canvas ) {
                ...
                switch( _nickName ) {
                    ...
                    default: {
                        _viewComponent = new BaseVTitleView( _canvas );
                        break;
                    }
                }

                BaseVTitleMediator.$super.constructor.call( this, MEDIATOR_NAME, _viewComponent );
