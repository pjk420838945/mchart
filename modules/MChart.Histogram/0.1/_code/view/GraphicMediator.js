;(function(define, _win) { 'use strict'; define( 'MChart.Histogram.View.GraphicMediator', [
    'MChart.Histogram.View.GraphicView'
], function( GraphicView ) {

    /*
     * 注意： 此处一定保持Mediator别名的唯一性 facade会按照别名区分注册的Mediator，别名相同会直接覆盖之前注册的Mediator
     */
    var _mediatorName = 'GRAPHIC_MEDIATOR';
        ...
        , {
            ...
            initialize: function( _nickName, _canvas ) {
                ...
                switch( _nickName ) {
                    ...
                    default: {
                        _viewComponent = new GraphicView( _canvas );
                        break;
                    }
                }
